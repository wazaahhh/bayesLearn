...
Problems regarding estimation of complex structures in high-dimensional joint distributions have a unique equivalence class, which constitutes the set of best solutions and which may be approached over time through iterative refinements of one's model, as well as through sudden structural epiphanies. Yet getting close to this solution is hard because interdependencies often have unintuitive observational consequences, or rather, observations often result from  probabilistic influence that is unintuitive to humans. \\
